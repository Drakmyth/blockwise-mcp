...
public final class FabricMinecraftServerToolExecutor implements McpToolExecutor {
    private final MinecraftServer server;
    private final Duration timeout;

    public FabricMinecraftServerToolExecutor(MinecraftServer server, Duration timeout) {
